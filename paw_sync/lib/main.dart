...
import 'package:paw_sync/core/theme/theme.dart'; // Import the theme
...
// Adjusted for explicit output path due to `synthetic-package: false` in l10n.yaml.
import 'package:paw_sync/core/localization/generated/app_localizations.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) { // WidgetRef added for ConsumerWidget
    ...
    return MaterialApp.router(
      ...
      onGenerateTitle: (BuildContext context) {
        // This provides the localized app title for the OS task switcher.
        return AppLocalizations.of(context)?.appTitle ?? 'Paw Sync';
      },

      // Theme settings from lib/core/theme/theme.dart
      theme: getAppThemeData(context),
      // TODO: Implement darkTheme and themeMode switching if needed
      // darkTheme: getAppDarkThemeData(context), // Assuming getAppDarkThemeData is defined in theme.dart
      // themeMode: ThemeMode.system, // Or a user-selectable theme mode
    );
  }
}
